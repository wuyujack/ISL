...
def parse_args():
    ...
    parser.add_argument('--task_stat_path',
                        ...
                        required=False,
                        type=str,
                        default='experiments/entity30_4_tasks.pkl')
    parser.add_argument('--exp_name',
                        help='experiment name',
                        required=False,
                        type=str,
                        default='debug_4_task_lr_5e-2_wd1e-4_mo9e-1_test')
...
def main():
    ...
    """
    task_stat_path = args.task_stat_path # 'entity30_4_tasks.pkl'
    ...
    each_task_test_size = 1500 # 4 task: 1500, 8 tasks: 750, 15 tasks: 400
    average_top1 = dict()
    target_top1 = dict()
