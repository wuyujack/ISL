...
def parse_args():
    ...
    parser.add_argument('--task_stat_path',
                        ...
                        required=False,
                        type=str,
                        default='experiments/entity13_13_tasks.pkl')
    parser.add_argument('--exp_name',
                        help='experiment name',
                        required=False,
                        type=str,
                        default='debug_13_task_lr_5e-2_wd1e-4_mo9e-1_test')
...
def main():
    ...
    task_stat_path = args.task_stat_path  # 'entity13_13_tasks.pkl'
    ...
    assert set.union(set(task_coarse_class_dict[1]), set(task_coarse_class_dict[2]), set(task_coarse_class_dict[3]),
                     ...
                     set(task_coarse_class_dict[13])) == set(target_train_dataset.class_to_idx.keys())
    ...
    each_task_test_size = 500 # 5 tasks: 1300, 10 tasks: 650, 13 task: 500
    average_top1 = dict()
    target_top1 = dict()
