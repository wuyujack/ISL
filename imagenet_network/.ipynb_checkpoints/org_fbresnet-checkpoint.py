...
__all__ = ['fbresnet50_squeeze','fbresnet50','fbresnet18','fbresnet34']
...
def fbresnet18(num_classes=1000, pretrained = False):
...
def fbresnet34(num_classes=1000, pretrained = False):
...
def fbresnet50(num_classes=1000, pretrained = False):
...
def fbresnet50_squeeze(num_classes=1000, pretrained = False):
    """Constructs a ResNet-50 model.
