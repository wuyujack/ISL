...
def parse_args():
    ...
    parser.add_argument('--task_stat_path',
                        ...
                        required=False,
                        type=str,
                        default='experiments/entity30_8_tasks.pkl')
    parser.add_argument('--exp_name',
                        help='experiment name',
                        required=False,
                        type=str,
                        default='debug_8_task_lr_1e-2_wd1e-4_mo9e-1_test')
...
def main():
    ...
    """
    task_stat_path = args.task_stat_path  # 'entity30_8_tasks.pkl'
    ...
    assert set.union(set(task_coarse_class_dict[1]), set(task_coarse_class_dict[2]), set(task_coarse_class_dict[3]),
                     ...
                     set(task_coarse_class_dict[7]), set(task_coarse_class_dict[8])) == set(target_train_dataset.class_to_idx.keys())
    ...
    each_task_test_size = 750 # 4 task: 1500, 8 tasks: 750, 15 tasks: 400
    average_top1 = dict()
    target_top1 = dict()
